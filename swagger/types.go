...
// Info holds the API title and version shown in Swagger UI.
type Info struct {
...
// contract so Swagger UI can show accurate documentation without relying
// on live request sniffing.
type RouteDoc struct {
	// Title / summary shown in Swagger UI for this endpoint.
	Title string
